    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Warp
          ...
          speed={1}
colors={[
  "hsl(345, 100%, 96%)",  // baby pink
  "hsl(20, 100%, 95%)",   // peach-cream
  "hsl(330, 100%, 92%)",  // light rose
  "hsl(350, 90%, 98%)",   // pale blush
  "hsl(40, 100%, 93%)",   // butter peach
  "hsl(300, 90%, 96%)",   // lilac-pink
  "hsl(0, 70%, 97%)",     // porcelain pink
  "hsl(15, 85%, 90%)"     // light salmon-pink
]}
